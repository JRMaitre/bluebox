    ...
    <div class="field">
        ...
        &nbsp;&nbsp;<?php echo html::anchor('mediafile/create', 'Add New Media', array('class' => 'qtipAjaxForm')); ?>
        &nbsp;&nbsp;<?php echo html::anchor('mediafile/record', 'Record New Media', array('class' => 'qtipAjaxForm')); ?>
    </div>
